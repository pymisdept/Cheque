...
namespace GeneralReport_Console
{
   ...
   internal static class NativeMethods {     
    ...
    static class Program
    {
            ...
            */
            ...
            if (args.Length >= 10)
            {
                ...
                if (choice == "PRINT")
                {
                    ...
                    {
                        updatedatabase(parameter_cheque_id, _connectionString, parameter_user_id);
                    }
        ...
        public static void updatedatabase(string _ChequeID, string _connectionString, string _UserID)
        {
            string updateString = "";

            //change for pass system user, begin
            updateString = "update Cheque set IsPrinted=1, Last_Updated_Date = getdate(), Last_Updated_User = '" + _UserID + "' where ChequeID=" + _ChequeID;
            //change for pass system user, end
